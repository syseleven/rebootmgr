...
def test_reboot_fails_without_tasks(run_cli, forward_port, consul1):
...
def test_reboot_success_with_tasks(run_cli, forward_port, consul1, consul_kv, reboot_task, mocked_run, mocker):
    forward_port.consul(consul1)
...
def test_reboot_fail(run_cli, forward_port, consul1, consul_kv, reboot_task, mocked_run, mocker):
    forward_port.consul(consul1)
...
def test_reboot_in_progress_other(run_cli, forward_port, consul_kv, consul1):
    forward_port.consul(consul1)
...
def test_post_reboot_phase_fails_without_tasks(run_cli, forward_port, consul_kv, consul1):
    forward_port.consul(consul1)
...
def test_post_reboot_phase_success_with_tasks(run_cli, forward_port, consul_kv, consul1, reboot_task):
    forward_port.consul(consul1)
